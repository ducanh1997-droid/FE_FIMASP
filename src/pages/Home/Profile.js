                                ...
                                <div id="content-profile">
                                    <div id='general-information'>
                                        ...
                                        <div className={"field-div-profile"}>
                                            ...
                                            <Field type="text" placeholder='Nhập tên của bạn' name={'fullName'} id='fullName'/>
                                        ...
                                        <div className={"field-div-profile"}>
                                            ...
                                            <Field type="text" placeholder='Số điện thoại' name={'phoneNumber'} id='phoneNumber'/>
                                            <div  className={"field-div-profile-error"}>
                                    ...
                                    <div id='address-information'>
                                        ...
                                        <div className='address-1'>
                                            ...
                                            <Field type="text" placeholder='Nhập địa chỉ của bạn' name={'address'} id='address'/>
                                        </div>
                                    ...
                                    <div id='button-save-profile' >
                                        <button type={'submit'} style={Object.keys(errors).length!==0
                                            ?{background:"rgb(141,191,114)",cursor:"not-allowed"}:{background:"rgb(79 161 34)",cursor:"pointer"}}>Lưu hồ sơ</button>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="content-profile">
                                        <div className="details-profile">
                                            ...
                                            <div className="descriptions-profile">
                                                ...
                                                <h3>{user.city}<br/><span>City</span></h3>
                                ...
                                <div className='attach-avatar' onClick={handleClick}>
                                    ...
                                    <div>
                                        <div className="attach-img8">
                                            {
                                                !image&&<img src="data:image/png;base64," alt=""/>
                                            }
                                            {
                                                image&&<img src={image} alt=""/>
                                            }
                                        ...
                                        <input type="file" className="form-control custom-file-input" id="image" ref={refInput}
